...
const Home = () => {
  return (
    <>
       ...
       <p>
       Actualmente trabajo de manera Freelace y ocasionalmente estoy disponible para proyectos con un fuerte énfasis en la accesibilidad, la equidad de género, la interseccionalidad, la justicia social y las artes. 
       </p>
       <p>
